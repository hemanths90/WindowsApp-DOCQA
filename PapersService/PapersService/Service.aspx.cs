...
namespace PapersService
{
    public partial class Service : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string question_id = Request.Form["questionID"] ?? String.Empty;
            string comment_content = Request.Form["textContent"] ?? String.Empty;
        ...
        {
            string retValue = string.Empty;
            string query = "select q.question_content, q.question_id, q.PaperText,a.comment_content,q.PaperID from questions q inner join answers a  on q.question_id=a.question_id where q.PaperID =  " + paperID;
        ...
        {
            string retValue = string.Empty;
            string query = "insert into Answers values(question_id, comment_content)";
